...
def generate_launch_description():
    ...
    launch_falcon_sim = ExecuteProcess(
        cmd=[[
            './Falcon.sh ',
            '-scenario=/home/vv/Semester_2/ENPM661/Project_3/UMD-ENPM661-AStar-FalconSim-Assignment/Scenarios/AMRPathPlanning/AMRPathPlanning.usda'
            ]],
        cwd="/home/vv/duality/falconsim/",
        shell=True
    )
